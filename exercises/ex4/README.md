...
<br>2. For **TypeName** property, add string value as **"Sales Order Item"**</br>
<br>For **TypeNamePlural** property, add string value as **"Sales Order Items"**</br>
<br>3. In the next line add **TypeImageUrl** property choosing from the suggestion list opened up by pressing CTRL/CMD + SPACE. Add string value as **"sap-icon://sales-order-item"**</br>
<br>5. In the next line add **Title** property by choosing from the suggestion list opened up by pressing CTRL/CMD + SPACE<br>
<br>6. Place your curser between PropertyValue tags and press CTRL/CMD + SPACE. From the options, choose **"DataField"** record and press ENTER</br>
...
<br>3. Press CTRL/CMD + SPACE to choose path for Value property as **"NetAmount"**</br>
<br>4. Repeat steps 1 - 3 for creating another DataPoint annotation</br>
<br>5. Keep the new DataPoint's qualifier as **Status** and Value path as **"SalesOrderStatus"**</br>
<br>Save the annotation file by clicking the ‘Save’ from File Menu or pressing CTRL/CMD + S. Your final annotation will look like below</br>
...
<br>2. Place the cursor between the Collection tags and press CTRL/CMD + SPACE to add a **ReferenceFacet** record</br>
<br>3. Press CTRL/CMD + SPACE to choose annotation path as **@UI.DataPoint#NetAmount**</br>
<br>4. Repeat steps 2 - 3 for creating another **ReferenceFacet** record annotation and set its annotation path as **@UI.DataPoint#Status**</br>
<br>Save the annotation file by clicking the ‘Save’ from File Menu or pressing CTRL/CMD + S. Your final annotation will look like below</br>
```xml
...
<br>2. Place the cursor between the Collection tags and press CTRL/CMD + SPACE to add **ReferenceFacet** record</br>
